...
for i = 1:length(datos2)
    ...
    voxelmorph_ventriculo_AD{i} = nii_seleccionado;
end

save('region_ventriculo_AD_volxelmorph.mat', 'voxelmorph_ventriculo_AD');
...
for i = 1:length(datos2)
    ...
    % Guardar el archivo .nii con la región seleccionada
    voxelmorph_talamo_AD{i} = nii_seleccionado;
end

save('region_talamo_AD_volxelmorph.mat', 'voxelmorph_talamo_AD');
...
for i = 1:length(datos2)
    ...
    % Guardar el archivo .nii con la región seleccionada
    voxelmorph_hipocampo_AD{i} = nii_seleccionado;
end

save('region_hipocampo_AD_volxelmorph.mat', 'voxelmorph_hipocampo_AD');