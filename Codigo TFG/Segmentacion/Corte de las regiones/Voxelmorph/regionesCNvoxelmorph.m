...
for i = 1:length(datos1)
    ...
    voxelmorph_ventriculo_CN{i} = nii_seleccionado;
end

save('region_ventriculo_CN_volxelmorph.mat', 'voxelmorph_ventriculo_CN');
...
for i = 1:length(datos1)
    ...
    % Guardar el archivo .nii con la región seleccionada
    voxelmorph_talamo_CN{i} = nii_seleccionado;
end

save('region_talamo_CN_volxelmorph.mat', 'voxelmorph_talamo_CN');
...
for i = 1:length(datos1)
    ...
    % Guardar el archivo .nii con la región seleccionada
    voxelmorph_hipocampo_CN{i} = nii_seleccionado;
end

save('region_hipocampo_CN_volxelmorph.mat', 'voxelmorph_hipocampo_CN');