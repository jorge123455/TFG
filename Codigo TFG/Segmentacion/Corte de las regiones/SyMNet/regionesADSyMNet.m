...
for i = 1:length(datos2)
    ...
    SyMNet_ventriculo_AD{i} = nii_seleccionado;
end

save('region_ventriculo_AD_SyMNet.mat', 'SyMNet_ventriculo_AD');
...
for i = 1:length(datos2)
    ...
    % Guardar el archivo .nii con la región seleccionada
    SyMNet_talamo_AD{i} = nii_seleccionado;
end

save('region_talamo_AD_SyMNet.mat', 'SyMNet_talamo_AD');
...
for i = 1:length(datos2)
    ...
    % Guardar el archivo .nii con la región seleccionada
    SyMNet_hipocampo_AD{i} = nii_seleccionado;
end

save('region_hipocampo_AD_SyMNet.mat', 'SyMNet_hipocampo_AD');