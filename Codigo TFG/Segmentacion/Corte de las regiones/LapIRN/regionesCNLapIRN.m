...
for i = 1:length(datos1)
    ...
    LapIRN_ventriculo_CN{i} = nii_seleccionado;
end

save('region_ventriculo_CN_LapIRN.mat', 'LapIRN_ventriculo_CN');
...
for i = 1:length(datos1)
    ...
    % Guardar el archivo .nii con la región seleccionada
    LapIRN_talamo_CN{i} = nii_seleccionado;
end

save('region_talamo_CN_LapIRN.mat', 'LapIRN_talamo_CN');
...
for i = 1:length(datos1)
    ...
    % Guardar el archivo .nii con la región seleccionada
    LapIRN_hipocampo_CN{i} = nii_seleccionado;
end

save('region_hipocampo_CN_LapIRN.mat', 'LapIRN_hipocampo_CN');