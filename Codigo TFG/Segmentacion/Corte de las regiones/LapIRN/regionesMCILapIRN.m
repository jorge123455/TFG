...
datos3 = load( 'C:\Users\Usuario\Desktop\TFG\matlab\Scripts\jacobianosYmediaMCI_LapIRNexf.mat' );
...
LapIRN_ventriculo_MCI = cell(length(datos3),1);
LapIRN_talamo_MCI = cell(length(datos3),1);
LapIRN_hipocampo_MCI = cell(length(datos3),1);
...
for i = 1:length(datos3)
    ...
    LapIRN_ventriculo_MCI{i} = nii_seleccionado;
end

save('region_ventriculo_MCI_LapIRN.mat', 'LapIRN_ventriculo_MCI');
...
for i = 1:length(datos3)
    ...
    % Guardar el archivo .nii con la región seleccionada
    LapIRN_talamo_MCI{i} = nii_seleccionado;
end

save('region_talamo_MCI_LapIRN.mat', 'LapIRN_talamo_MCI');
...
for i = 1:length(datos3)
    ...
    % Guardar el archivo .nii con la región seleccionada
    LapIRN_hipocampo_MCI{i} = nii_seleccionado;
end

save('region_hipocampo_MCI_LapIRN.mat', 'LapIRN_hipocampo_MCI');